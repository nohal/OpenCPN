...
SaveDefaultsDialog::SaveDefaultsDialog(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, id, _("Save some defaults"), wxDefaultPosition, wxDefaultSize);
    GridBagSizer1 = new wxGridBagSizer(0, 0);
    StaticText1 = new wxStaticText(this, wxID_ANY, _("Check which properties of current waypoint\n should be set as default for NEW waypoints."), wxDefaultPosition, wxDefaultSize, 0);
    ...
    IconCB = new wxCheckBox(this, wxID_ANY, _("Icon")+ _T("    [") + s +_T("]"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
    ...
    RangRingsCB = new wxCheckBox(this, wxID_ANY, _("Range rings")+ _T("    [") + s +_T("]"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
    GridBagSizer1->Add(RangRingsCB, wxGBPosition(3, 1), wxDefaultSpan, wxALL, 5);
    s = ( g_pMarkInfoDialog->m_textArrivalRadius->GetValue());
    ArrivalRCB = new wxCheckBox(this, wxID_ANY, _("Arrival radius")+ _T("    [") + s +_T("]"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
    ...
    s = ( g_pMarkInfoDialog->m_checkBoxScaMin->GetValue() ? 
        ...
        _("Show always") );
    ScaleCB = new wxCheckBox(this, wxID_ANY, _("Show only at scale")+ _T("    [") + s +_T("]"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
