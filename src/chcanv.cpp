...
void ChartCanvas::canvasRefreshGroupIndex()
{
...
void ChartCanvas::InvalidateQuilt()
{
...
void ChartCanvas::SubmergeToolbar()
{
    if( m_toolBar )
        m_toolBar->Submerge();
}

void ChartCanvas::SurfaceToolbar()
{
    if( m_toolBar )
        m_toolBar->Surface();
}
...
void ChartCanvas::FormatPianoKeys()
{
    m_Piano->FormatKeys();
